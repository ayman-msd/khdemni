...
public class CandidatDTO {
  ...
  public CandidatDTO(int id, String firstname, String lastname, String email, String phone, String password, String role, String skills, List<Candidature> candidatures) {
    this.id = id;
